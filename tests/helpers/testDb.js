...
const TABLES_TO_CLEAR = [
  ...
  "account_bank_ledgers",
  "petty_cash_entries",
  "gst_return_records",
  "vendor_payment_records",
  "purchase_orders",
  "payroll_records",
  "profit_center_entries",
...
const seedDatabase = async () => {
  ...
  await runQuery(`
    ...
    VALUES
      ...
      (3, 3, '201', NULL, 'Available', NULL, NULL)
    ON DUPLICATE KEY UPDATE
  ...
  await runQuery(`
    ...
    ON DUPLICATE KEY UPDATE
      ...
      tax = VALUES(tax),
      happy_hour_price = VALUES(happy_hour_price),
      happy_hour_start = VALUES(happy_hour_start),
      happy_hour_end = VALUES(happy_hour_end)
  `);
  ...
  await runQuery(`
    ...
    ON DUPLICATE KEY UPDATE
      ...
      menu_package_id = VALUES(menu_package_id),
      meal_section = VALUES(meal_section),
      custom_menu_items = VALUES(custom_menu_items),
      lighting_system = VALUES(lighting_system),
  ...
  await runQuery(`
    ...
    ON DUPLICATE KEY UPDATE
      ...
      ready_message = VALUES(ready_message)
  `);
